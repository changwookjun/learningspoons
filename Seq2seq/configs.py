...
tf.app.flags.DEFINE_integer('batch_size', 20, 'batch size') # 배치 크기
tf.app.flags.DEFINE_integer('train_steps', 8000, 'train steps') # 학습 에포크
...
tf.app.flags.DEFINE_integer('max_sequence_length', 31, 'max sequence length') # 시퀀스 길이 21
